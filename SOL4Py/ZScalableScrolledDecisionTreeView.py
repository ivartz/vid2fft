...
#
#******************************************************************************/
#  ZScalableScrolledDecisionTreeView.py
...
class ZScalableScrolledDecisionTreeView(ZScalableScrolledImageView):

  def __init__(self, parent, x, y, width, height):
    super(ZScalableScrolledDecisionTreeView, self).__init__(parent, x, y, width, height)
